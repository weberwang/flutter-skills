...
5. 填写 [asset manifest](references/asset-manifest-template.md)，再用 `scripts/render-bitmap-confirmation.py` 从 exact frozen target 生成编号图。Controller 只展示图片并等待用户明确确认。
