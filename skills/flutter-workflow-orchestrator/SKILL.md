...
- `references/asset-atlas-flow.md`: Read before shared HTML interactive prototype work or module HTML interactive prototype work whenever non-standard bitmap assets may be required.
