...
- The prototype must show the module pages' complete layout, interaction flow, state switching, scroll ownership, sticky regions, overlays, and any other structure semantics that would otherwise be easy to misread from prose alone.
...
- The confirmed native HTML prototype is review evidence and interaction evidence. It does not replace the module Pencil design source as the frozen implementation design file.
