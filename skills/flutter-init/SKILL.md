---
name: flutter-init
description: Use when initializing a Flutter project from an RD document generated by flutter-prd-rd-writer, especially when the task is to scaffold the app shell, DDD features, package wiring, route skeleton, project-required network or storage baseline, annotation-driven code generation, and a project-local flutter-dev skill instead of writing the RD itself.
---
...
2. Extract the bootstrap contract from the RD: app type, features, routes, auth, data sources, local storage, tests, and release constraints.
...
- Initial router, bootstrap, error, logging, and any project-required network or storage wiring.
