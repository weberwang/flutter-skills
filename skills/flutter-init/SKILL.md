---
name: flutter-init
description: Use when initializing a Flutter project from an RD document generated by flutter-prd-rd-writer, especially when the task is to scaffold the app shell, DDD features, package wiring, route skeleton, network layer, storage baseline, annotation-driven code generation, and a project-local flutter-dev skill instead of writing the RD itself.
---
