...
- For Flutter preview images used as supplemental app-page evidence, Product Design:ideate owns the pre-confirmation sketch stage and the Product Design-owned final effect-image direction pass unless the user explicitly wants the richer Creative Production asset branch.
