...
Route those cases to the approved image-backed design-source flow before using this skill. If the target is global design freezing, return `blocked` directly, ask the user whether to fall back, and do not produce freeze artifacts.
