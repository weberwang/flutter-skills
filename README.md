...
- 全局视觉探索优先验证产品性格、构图差异、情绪活力和任务清晰度，以 Apple Human Interface Guidelines 和 iOS/Cupertino 语义作为交互、无障碍与平台基线，但不得以普通 Flutter Widget、原生 Cupertino 外观或后续资产工作量作为视觉上限；方向选定后再记录原生组件、自定义组件、`CustomPainter`、Shader/动效或位图资产的实现路径和成本。
