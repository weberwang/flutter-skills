...
3. Write a mockup brief for the current module or page with [references/mockup-brief-template.md](references/mockup-brief-template.md), including the active visual expression preset, page-type budget dial, and whether a restatable signature moment is required.
