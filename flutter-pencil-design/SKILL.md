...
10. Run an independent review with [references/wireframe-review-template.md](references/wireframe-review-template.md). Review semantic completeness and the selected level, not visual similarity or layout polish.
