...
- No work dispatch before the Team Assembly Gate records the task profile, enabled and omitted core roles with reasons, one DRI, one independent acceptance owner, agent IDs, accepted upstream evidence, and non-overlapping write scopes.
