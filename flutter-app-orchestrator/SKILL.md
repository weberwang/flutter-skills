...
- No next-task handoff before the confirmed task has completed `finalize-task.py`, including its task worktree/local-branch cleanup, and completed its scoped artifact cleanup or recorded `N/A` in `docs/tasks/<task-id>/evidence/manifest.md`.
