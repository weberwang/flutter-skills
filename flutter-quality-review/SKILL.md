...
- Page high-fidelity mockup frozen under `.codex-workflow/visuals/pages/<page-name>/`, plus global and page design-freeze constraints.
...
- Freeze-record integrity: the selected page image is stored under `.codex-workflow/visuals/pages/<page-name>/` before related visual artifacts, and its candidate ID, decoded dimensions, SHA-256, and user confirmation time match the design freeze and ledger.
